...
const ViewDetails = () => {
    ...
    <div className="max-w-md mx-auto">
        <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold mb-6 text-gray-900">Lawyer Details</h2>
        ...
        {lawyerDetails ? (
            <div className="flex flex-col items-center bg-gray-100 p-6 rounded-lg shadow-md">
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-4">
                    <Link to={`/make-booking/${id}`} className="bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:scale-105 shadow-lg">Make Booking</Link>
                    <Link to={`/make-review/${id}`} className="bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded transition duration-200 ease-in-out transform hover:scale-105 shadow-lg">Make Review</Link>
                </div>
            </div>
        ) : (
    ...
    <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-8 text-center">Reviews:</h2>
    <div className="max-w-md mx-auto">
        {reviews.length > 0 ? (
